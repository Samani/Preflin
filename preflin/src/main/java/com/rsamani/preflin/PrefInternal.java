...
public class PrefInternal implements PrefInterface {
    ...
    private <T> T getCastObject(String key, Class<T> tClass) {
        ...
        try {
            return Serialize.objectFromString(s, tClass);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    private <T> T getCastObject(String key, Class<T> tClass, T defaultValue) {
        ...
        if (!TextUtils.isEmpty(s)) {
            try {
                obj = Serialize.objectFromString(s, tClass);
            } catch (Exception e) {
                e.printStackTrace();
                obj = null;
            }
    ...
    private <T> List<T> getCastListObject(String key, Class<T> tClass) {
        ...
        try {
            return Serialize.listOjectFromStddring(s, tClass);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    private <T> List<T> getCastListObject(String key, Class<T> tClass, List<T> defaultValue) {
        ...
        if (!TextUtils.isEmpty(s)) {
            try {
                obj = Serialize.listOjectFromStddring(s, tClass);
            } catch (Exception e) {
                e.printStackTrace();
                obj = null;
            }
